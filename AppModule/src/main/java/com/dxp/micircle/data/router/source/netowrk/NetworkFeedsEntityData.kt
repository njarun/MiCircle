package com.dxp.micircle.data.router.source.netowrk
...
class NetworkFeedsEntityData @Inject constructor(private val FirebaseFirestore: FirebaseFirestore) : FeedsEntityData {
